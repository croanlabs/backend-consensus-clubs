...
cleos push action $EOS_USERNAME newcandidate "[2, \"The Crypto Intro\",\"Author: Nathan Rose\", \"@placeholder\"]" -p $EOS_USERNAME
cleos push action $EOS_USERNAME newcandidate "[2, \"Digital Gold\",\"Author: Nathaniel Popper\", \"@placeholder\"]" -p $EOS_USERNAME
